...
export const useAdminSell = () => {
  ...
  const onAddSell = useItemStore(state => state.onAddSell)
  const onDeleteSell = useItemStore(state => state.onDeleteSell)
