  ...
  return (
    <div className="flex h-full gap-[20px]">
      <aside data-id="사이드 메뉴" className="flex h-full w-[280px] flex-col rounded-[20px] bg-white">
        ...
        <div data-title="사이드 본문" className="flex grow-1 flex-col gap-[30px] p-[20px]">
          ...
          <div data-title="사본 이지로그인" className="flex flex-col gap-[10px]">
            <div className="flex w-full justify-between">
              ...
              <Image className="cursor-pointer" src="/top.svg" alt="top" width={24} height={24} />
            </div>
      ...
      <section data-id="본문" className="flex h-full grow-1 flex-col rounded-[20px] bg-white">
        <div data-title="본몬 헤더" className="gap-10px] p-[20px]">
          <Text className="text-[20px] font-semibold">제품 소개</Text>
        </div>
        <hr className="border-gray2" />
        <div data-title="본문 소셜" className="gap-10px] p-[20px]">
          <div className="flex gap-[10px]">
            <div className="border-gray3 flex grow-1 cursor-pointer justify-center gap-[10px] rounded-[15px] border p-[20px]">
        ...
        <hr className="border-gray2" />
        <div className="grow-1 gap-[10px] p-[20px]">
          <div className="flex gap-[10px]">
            <div className="border-gray3 flex grow-1 flex-col items-center justify-center gap-[10px] rounded-[15px] border p-[20px]">
              <Image src="/home1.svg" alt="home" width={253} height={253} />
              <div className="flex flex-col gap-[10px] text-center">
                <Text className="text-[20px] font-bold text-black">소셜로그인 간편 구현</Text>
                <Text className="text-gray4 font-normal">
                  이지로그인에서 제공하는 <br />
                  API를 사용하여 간편하게 <br />
                  소셜로그인을 구현할 수 있습니다
                </Text>
            ...
            <div className="border-gray3 flex grow-1 flex-col items-center justify-center gap-[10px] rounded-[15px] border p-[20px]">
              <Image src="/home2.svg" alt="home" width={253} height={253} />
              <div className="flex flex-col gap-[10px] text-center">
            ...
            <div className="border-gray3 flex grow-1 flex-col items-center justify-center gap-[10px] rounded-[15px] border p-[20px]">
              <Image src="/home3.svg" alt="home" width={253} height={253} />
              <div className="flex flex-col gap-[10px] text-center">
                <Text className="text-[20px] font-bold text-black">소셜로그인 간편 구현</Text>
                <Text className="text-gray4 font-normal">
                  소셜로그인 구현시간을 <br />
